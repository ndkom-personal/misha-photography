        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { src: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1609220136736-443140cffec6?w=600&q=80", position: "center 35%" },
              { src: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1511895426328-dc8714191300?w=600&q=80", position: "center 35%" },
              { src: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?w=600&q=80", position: "center 25%" },
              { src: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=600&q=80", position: "center 25%" },
            ].map((img, index) => (
              <div
                key={index}
